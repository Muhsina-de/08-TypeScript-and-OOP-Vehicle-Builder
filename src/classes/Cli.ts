    ...
    inquirer
      ...
      .then((answers) => {
        ...
        // TODO: add statements to create a truck or motorbike if the user selects the respective vehicle type
          ...
          // if the user does not select a vehicle type, return to the startCli method
          this.startCli();
        }
      });
  }
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        if (answers.vehicleToTow instanceof Truck) {
          ...
          this.selectedVehicleVin = answers.vehicleToTow.vin;
          // perform actions on the truck
          this.performActions();
        }
  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // TODO: add statements to perform the tow action only if the selected vehicle is a truck. Call the findVehicleToTow method to find a vehicle to tow 
        // and pass the selected truck as an argument. After calling the findVehicleToTow method, 
